defmodule Cinder.Selection do
  ...
  @doc false
  def rendered_selected_ids_from_ids(:all_matching, selected_ids, item_ids) do
    MapSet.difference(item_ids || MapSet.new(), selected_ids)
  end

  def rendered_selected_ids_from_ids(_mode, selected_ids, _item_ids),
    do: selected_ids
